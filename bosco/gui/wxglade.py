# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.5 on Sat Jun 13 13:58:40 2020
#
...
from bosco.gui.wxutil import RunPanel
...
class RunEditorFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.main_frame_menubar.open_runs = self.reports.Append(wx.ID_ANY, "&Open runs", "List not yet completed runs")
        self.Bind(wx.EVT_MENU, self.OpenRuns, id=self.main_frame_menubar.open_runs.GetId())
        self.main_frame_menubar.orphan_runs = self.reports.Append(wx.ID_ANY, "&Orphan runs", "List runs not connected to a runner")
        self.Bind(wx.EVT_MENU, self.OrphanRuns, id=self.main_frame_menubar.orphan_runs.GetId())
        ...
        self.Bind(wx.EVT_MENU, self.ConnectReader, id=self.main_frame_menubar.connect_reader.GetId())
        self.main_frame_menubar.print_command = self.settings.Append(wx.ID_ANY, "&Print command", "")
        self.Bind(wx.EVT_MENU, self.SetPrintCommand, id=self.main_frame_menubar.print_command.GetId())
...
class TeamPanel(EditingPanel):
    def __init__(self, *args, **kwds):
        ...
        self.team_combo = wx.ComboBox(self, wx.ID_ANY, choices=[], style=0)
    ...
    def __do_layout(self):
        ...
        sizer_22.Add(self.label_11, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
    ...
    def ChangeTeam(self, event):  # wxGlade: TeamPanel.<event_handler>
        print("Event handler 'ChangeTeam' not implemented!")
        event.Skip()
...
class EditRunPanel(RunPanel):
    ...
    def __do_layout(self):
        ...
        sizer_19.Add(self.rollback, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.EXPAND, 2)
        sizer_19.Add(self.delete, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.EXPAND, 2)
        sizer_19.Add(self.add_button, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.EXPAND, 2)
        sizer_19.Add(self.registration, 0, wx.ALL, 2)
        sizer_19.Add(self.print_button, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.EXPAND, 2)
        ...
        sizer_8.Add(label_2, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 0)
        sizer_8.Add(self.run_runner_combo, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 0)
        ...
        sizer_29.Add(self.label_4, 0, wx.ALIGN_CENTER_VERTICAL | wx.BOTTOM | wx.LEFT | wx.TOP, 0)
        sizer_29.Add(self.runner_dateofbirth, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT | wx.ALL, 0)
        ...
        sizer_8.Add(label_22_copy, 0, wx.ALL, 0)
        sizer_8.Add(self.runner_club, 0, wx.ALL | wx.EXPAND, 0)
        ...
        sizer_4.Add(label_3, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 0)
        sizer_4.Add(self.course, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 0)
        sizer_4.Add((10, 5), 0, 0, 0)
    ...
    def FieldChanged(self, event):  # wxGlade: EditRunPanel.<event_handler>
